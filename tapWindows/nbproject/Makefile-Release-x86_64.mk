...
# C Compiler Flags
CFLAGS=-m64 -static-libgcc $(shell pkg-config --cflags jdk) ${EXTRA_CFLAGS}
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/Release/libTunTapWindows64.dll

dist/Release/libTunTapWindows64.dll: ${OBJECTFILES}
